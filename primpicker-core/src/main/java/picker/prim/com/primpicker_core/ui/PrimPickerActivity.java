...
public class PrimPickerActivity extends AppCompatActivity implements FileLoaderCallback.LoaderCallback,
    ...
    private void selectFinish(SelectItemCollection selectItemCollection) {
        ...
        result.putParcelableArrayListExtra(EXTRA_RESULT_SELECTION, selectItemCollection.asListOfUri());
        result.putStringArrayListExtra(EXTRA_RESULT_SELECTION_PATH, selectItemCollection.asListOfString());
